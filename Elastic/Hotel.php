      ...
      <div class="mx-auto">
        <div class="post-preview">
          <!-- <form class="form-inline d-flex justify-content-center md-form form-sm mt-0" autocomplete="off" action="index.php" method="GET">
            ...
            <input class="form-control mr-sm-4" name="ES" type="text" placeholder="Search" aria-label="Search" >
            <button class="btn btn-info btn-sm my-2" type="submit">Search</button>
          </form> -->
          <br>
        </div>
        <div class="post-preview">
          <h2>ที่พักทั้งหมด</h2>
          <table id="tb1" class="table" cellspacing="0" width="120%">
            <thead>
              <tr>
